...
export class BooksView extends Component {
    ...
    async componentDidMount() {
        const {currentPage, currentCategory, searchPhrase, sortColumn} = this.state;
            ...
            <React.Fragment>
                <div>
                    ...
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        ...
                        <div className={'form-element'}>
                            {currentCategory && <h6>{categoriesLookup.get(currentCategory)}</h6>}
                        </div>

                        <div>
                            {logged && !adding && !editedBook && (
                                <button className="btn btn-warning form-element" onClick={this.handleAdd}>
                                    Dodaj książkę
                                </button>
                            )}
                        </div>
                        ...
                        <form onSubmit={this.handleSearchSubmit} noValidate style={{display: 'flex', alignItems: 'center'}}>
                            <div className={'form-element'}>
                                <input
                            ...
                            <div>
                                <button className="btn btn-info form-element">
                                    Szukaj
                                </button>
                            </div>
                        </form>
